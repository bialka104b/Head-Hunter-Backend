export class ValidationError extends Error {
	static messages = {
		recordInstanceInit: {
			...
			interview: {
				incorrectRelationId:
					'Incorrect interview\'s object data. "HrId" and "traineeId" keys can not be empty and have to match user\'s ids.',
			},
			hrProfile: {
				incorrectNameOrCompany:
					'Incorrect hr-profile\'s object data. Please provide data for "fullName" and "company" keys.',
				incorrectRelationId:
					'Incorrect hr-profile\'s object data. "UserId" key can not be empty and have to match user\'s ids.',
			},
			traineeScore: {
				incorrectScore:
					'Incorrect trainee-score\'s object data. "CourseCompletion", "courseEngagment", "projectDegree", "teamProjectDegree" keys can not be empty and have to be between 0 and 5.',
			},
			traineeProfile: {
